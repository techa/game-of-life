...
export class Rules<T extends RulesData> extends Array<T> {
	...
	private _parse(ruleStr: string): RuleArguments {
		...
		throw new Error(`"${ruleStr}" is invaild rule string.`)
	}
...
export const rules = new Rules(
	...
	// {name: 'g', rule: 'B368/S245'},
	{ name: 'Island', rule: 'B5678/S345678' }, //randomCorrection(5)系と相性よし
	{ name: 'Factory', rule: 'B478/S45678' }, //randomCorrection(5)系と相性よし、step30で直線的
	{ name: 'craggy', rule: 'B4678/S45678' }, //randomCorrection(5)系と相性よし、生成が速い。step10
	// Generation
	...
	{ name: 'Nova', rule: 'B2478/S45678/C25' }, //step:地形データに使えそう。かなり面白い
